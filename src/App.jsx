      ...
      <div className='relative isolate px-6 pt-14 lg:px-8'>
        ...
        <div className='mx-auto max-w-2xl py-16 sm:py-24 lg:py-28'>
          ...
          <div className='text-center'>
            <h1 className='text-balance text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl uppercase'>
        ...
        <div className='bg-blue-50 py-12'>
          <div className='container mx-auto grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 max-w-6xl'>
              ...
              return (
                ...
                >
                  <div className='text-4xl text-blue-600 mb-4'>
                    {/* Add your icons here, using a library like FontAwesome or HeroIcons */}
                    <Icon height={'30px'} />
                  </div>
